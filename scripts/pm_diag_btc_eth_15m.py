#!/usr/bin/env python3
"""Diagnose BTC/ETH 15m markets: web list -> gamma market -> clob book."""
import json, subprocess, requests

WEB_URL = "https://polymarket.com/zh/crypto/15M"
...
# 2) pick BTC/ETH 15m
candidates = [m for m in markets if ("15" in (m.get("question") or "") or "15m" in (m.get("question") or "")) and ("btc" in (m.get("question") or "").lower() or "bitcoin" in (m.get("question") or "").lower() or "eth" in (m.get("question") or "").lower() or "以太坊" in (m.get("question") or ""))]
